...
export function HookSection({
  ...
  return (
    ...
    >
      {/* Centre — what it is and why it exists. */}
      ...
      <div className="min-w-0 lg:sticky lg:top-6 lg:self-start">
        <div className="surface overflow-hidden">
          ...
          <dl className="border-line text-muted flex gap-5 border-t border-b px-4 py-2 font-mono text-xs">
            ...
            <div className="flex min-w-0 gap-1.5">
              <dt>error</dt>
              <dd className={`truncate ${error ? 'text-danger' : 'text-fg'}`}>
                {error ? `"${error}"` : 'null'}
              </dd>
            </div>
          </dl>
          ...
          <div className="p-4">
            {loading ? (
              ...
              <div className="flex flex-col gap-3">
                <pre className="bg-bg border-line overflow-x-auto rounded-md border p-3 font-mono text-xs">
