...
// Lucide dropped brand icons, and Fumadocs only exposes its GitHub mark through
// the `githubUrl` shortcut — which it always appends *after* `links`. Declaring
// the link ourselves is the only way to put GitHub ahead of the support button.
const GITHUB_ICON = (
